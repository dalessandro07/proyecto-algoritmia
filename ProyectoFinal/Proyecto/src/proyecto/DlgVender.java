...
public class DlgVender extends JDialog implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent e) {
		...
		case 0: impC = cantidad*frmPrincipal.precio0; break;
		case 1: impC = cantidad*frmPrincipal.precio1; break;
		case 2: impC = cantidad*frmPrincipal.precio2; break;
		case 3: impC = cantidad*frmPrincipal.precio3; break;
		default: impC = cantidad*frmPrincipal.precio4; break;
		}
		//Calculando el importe de descuento
		if(cantidad<=5) impD=impC/100*frmPrincipal.porcentaje1;
		else if(cantidad<=10) impD=impC/100*frmPrincipal.porcentaje2;
		else if(cantidad<=15) impD=impC/100*frmPrincipal.porcentaje3;
		else impD=impC/100*frmPrincipal.porcentaje4;
		impP = impC - impD;
		if(cantidad<=5) canobsequio = cantidad*frmPrincipal.obsequioCantidad1;
		else if(cantidad<=10) canobsequio = cantidad*frmPrincipal.obsequioCantidad2; 
		else canobsequio = cantidad*frmPrincipal.obsequioCantidad3;
